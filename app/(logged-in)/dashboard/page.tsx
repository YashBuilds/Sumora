  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="container mx-auto flex flex-col gap-4">
        <div className="flex gap-4 mb-8 mt-8 justify-between">
          <div className="flex flex-col gap-2">
            <h1 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-gray-600 to-gray-900 bg-clip-text text-transparent">
              Your Summaries
            </h1>
